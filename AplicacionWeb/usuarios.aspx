...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container my-5">
        ...
        <div class="card shadow rounded-4 p-4">
            <asp:Button ID="btnNuevoUsuario" runat="server" Text="Nuevo Usuario" CssClass="btn btn-success mb-3" AutoPostBack="false" OnClientClick="mostrarModalUsuario()" />
    ...
    <!-- Script para abrir el modal desde el servidor -->
